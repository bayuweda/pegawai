...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="w-full lg:max-w-4xl">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-[#1b1b18] dark:text-white">Sistem Informasi Pegawai</h1>

        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

            <div class="group relative bg-white dark:bg-[#161615] p-6 rounded-2xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-xl transition-all duration-300">
                <div class="absolute top-6 right-6 text-[#f53003] opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <div class="relative">
                    ...
                    <h3 class="text-xl font-bold dark:text-white">Database Pegawai</h3>
                    <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mt-2 mb-6">Akses seluruh data profil, jabatan, dan masa kerja pegawai secara real-time.</p>

                    <a href="/pegawai" class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#f53003] hover:bg-[#d62a02] text-white font-medium rounded-lg transition-all">
                        Buka Aplikasi
            ...
            <div class="group relative bg-white dark:bg-[#161615] p-6 rounded-2xl border border-[#e3e3e0] dark:border-[#3E3E3A] shadow-sm hover:shadow-xl transition-all duration-300">
                <div class="absolute top-6 right-6 text-[#706f6c] opacity-10 group-hover:opacity-20 transition-opacity">
                    <svg class="w-24 h-24" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM11 18H5v-2h6v2zm8-4H5v-2h14v2zm0-4H5V8h14v2z" />
                    </svg>
                </div>

                <div class="relative">
                    <div class="w-12 h-12 bg-gray-50 dark:bg-gray-800 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-[#1b1b18] dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold dark:text-white">Developer API</h3>
                    <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mt-2 mb-6">Integrasikan data pegawai ke aplikasi pihak ketiga melalui endpoint JSON API kami.</p>

                    <a href="/api/pegawai" target="_blank" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-[#252523] border border-[#e3e3e0] dark:border-[#3E3E3A] text-[#1b1b18] dark:text-white font-medium rounded-lg hover:bg-gray-50 transition-all">
                        Dokumentasi API
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
